export default function Navbar() {
  return (
    <nav className="absolute flex justify-between items-center my-10 w-[95vw] text-white">
        <a href="/" className="font-alegreya text-4xl tracking-[.10em] ml-24">Snake River Woodworks</a>
        <div className="flex items-center">
            ...
            <div className="px-6 flex flex-col">
                ...
                <span className="hover-underline-animation text-[22px] font-alegreya">
                    <a href="/careinfo">Care / Maintenance</a>
                </span>
            </div>
            <div className="px-6 flex flex-col">
